...
public class HGetChapterContent implements GoGoHandle {
    @Override
    public void handle(JsonElement requestData, JsonObject responseData) throws InterruptedException {
        ...
        // s to t
        // 439 com.qidian.QDReader.component.bll.C4730w
        com.qidian.QDReader.component.bll.w sObj = new com.qidian.QDReader.component.bll.w(source, bookId, chapterId, false, false, "", chapterContentHandler);
        // C to E
        // m18187G
        sObj.G();
        // L to N
...
//         sObj.P();
    ...
    // com.qidian.QDReader.component.bll.callback.InterfaceC4590b
